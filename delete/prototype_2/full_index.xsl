...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    version="2.0">
    <xsl:template match="/">
        <xsl:call-template name="index_nav"/>
    ...
    <xsl:template name="index_nav">
        <xsl:result-document href="index_nav.html">
            <xsl:call-template name="modal"/>
        </xsl:result-document>
    </xsl:template>
    <xsl:template name="modal">
        <link href="stylesheet.css" rel="stylesheet"/>
        <button id="myBtn">Browse index</button>
            ...
            <div class="modal-content">
                ...
                <div class="nav_menu">
                    ...
                    <ul>
                        ...
                        <li><button>Families</button></li>
                        <li><button>Corporate bodies</button></li>
                    </ul>
                    <h2><button>Topics</button></h2>
                </div>
            </div>
